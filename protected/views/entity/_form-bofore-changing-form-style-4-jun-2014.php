        ...
        <li><a href="#tabs-more"><?php echo $Getlabelname->Get_Labelname_Fnc("200");?></a></li>
               ...
               <div id="inner_org_contents_basic">
                   <div width="15%" style="float:left;padding: 15px 8px 0px;">
                       ...
                       <div style="width:20%">
                                <table style="padding: 11px 0 0 25px; float: left;">
                                        <tr>
                                            <td>
...
<!------CODE FOR GENERIC FLEX ENDDDD---------->
                                ...
                                <table class="org_basic">
                                    <tr>
                                       ...
                                       <div class="input-append">
                                        <?php 
                                         ...
                                         ?>
                                         <a class="field_level_help_on_txt" href="#Organisation Name ">
                                  ...
                                  <tr>
                                        ...
                                        <td class="td_org">
                                        <div class="input-append">
                                        <?php echo $form->textField($model,"SHORT_NAME",array("class"=>"org_shortname","id"=>"SHORTNAME",'value'=>$vEntityCode,'maxlength' => 30)); ?>
                                        <a class="field_level_help_on_txt" href="#Organisation Code">
                                         <span class="add-on" style="width:3px !important"></span>
                                        </a>
                                        </div>
                                        </td>                   
                                        ...
                                        <div class="input-append">                         
                                            ...
                                            ?> 
                                         <a class="field_level_help_on_txt" href="#Registered On">
                                         <span class="add-on" style="width:3px !important"></span>
                                        </a>
...
//******************** FOR UPDATION ******************************8                                
               ...
               // ################### FOR NULL TEXT-FIELDS ########################### ############################## #####################                          
                ...
                // ################### FOR NULL TEXT-FIELDS ###########################  ###################################################                            
                        ...
                        ?>
                            <tr class="spaceUnder">
                                <th  class="" style="width :129px !important">
                                     <?php echo $value['FIELD_TITLE'];?>  </th>
                                <td style="padding: 0 0 12px 13px;">
...
<!--                  //take array's tot count and assign in value              -->
      ...
      <div id="tabs-contact" class="tabcontent">
                                               ...
                                               <td>
                                                <table>
                                                       <tr>                                                          
                                                            ...
                                                            <td><?php echo $form->textField($model_contact,"[$i]MOBILE_PHONE",array("class"=>"inputcontact","id"=>"MOBILE_PHONE-$i",'value'=>$vMobile[$i],'maxlength' => 50,)); ?></td>
                                                       </tr>
                                                       <tr>                                                          
                                                            <th class="addresshead"><?php echo $Getlabelname->Get_Labelname_Fnc("110");?></th>                                                        
                                                            <td><?php echo $form->textField($model_contact,"[$i]TELEPHONE",array("class"=>"inputcontact","id"=>"TELEPHONE-$i",'value'=>$vTelephone[$i],'maxlength' => 100,)); ?></td>
                                                       </tr>
                                                       <tr>                                                          
                                                            <th class="addresshead"><?php echo $Getlabelname->Get_Labelname_Fnc("111");?></th>                                                        
                                                            <td><?php echo $form->textField($model_contact,"[$i]FAX",array("class"=>"inputcontact","id"=>"FAX-$i",'value'=>$vFax[$i],'maxlength' => 50,)); ?></td>
                                                       </tr>
                                                       <tr>                                                          
                                                            <th class="addresshead"><?php echo $Getlabelname->Get_Labelname_Fnc("112");?></th>                                                        
                                                            <td><?php echo $form->textField($model_contact,"[$i]EMAIL",array("class"=>"inputcontact","id"=>"EMAIL-$i",'value'=>$vEmail[$i],'maxlength' => 100,)); ?></td>
                                                       </tr>
                                                       <tr>                                                          
                                                            <th class="addresshead"><?php echo $Getlabelname->Get_Labelname_Fnc("157");?></th>                                                        
                                                            <td><?php echo $form->textField($model_contact,"[$i]URL",array("class"=>"inputcontact","id"=>"URL-$i",'value'=>$vUrl[$i],'maxlength' => 100,)); ?></td>
                                                       </tr>
                                                   </table>
                                               </td>
                                            </tr>
                                             <tr>
                                                <td colspan="2">
                                                    <table style="margin-top: 11px;">
                                                       <th class="text-right"><?php echo $Getlabelname->Get_Labelname_Fnc("126");?></th>
       ...
       <fieldset>
           ...
           if(isset($_GET['id']) && count($getBank) == 1 && $getBank[$i-1]['WET']!="")
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php              
                                                      ...
                                                      'options' => array('dateFormat'=>'dd/mm/yy','changeMonth' => 'true','changeYear' => 'true','constrainInput' => 'true',		
                                                      'duration'=>'fast','showAnim' =>'slide'),'htmlOptions' => array('id'=>"CURRENCY_WET-$i",'value'=>$currencyWet[$i],'class'=>'datecollast paddate')));
                                                ?> 
                                            </td>
                                             <td>
