...
#table_bottom_bg { margin-left: -7px !important;width: 1161px !important;height: 33px !important; }  
...
<?php
  ...
  $GetGenericFlex_bank =$GET_GENERIC_FLEX->Get_Generic_Flex_With_Left_Join_Fnc('ENTITY_BANK','PARTY_BANK');
  $GetGenericFlex_party =$GET_GENERIC_FLEX->Get_Generic_Flex_With_Left_Join_Fnc('PARTY','PARTY_ADD_INF');
...
?>
                          ...
                          <input type="hidden" name="<?php echo $key;?>flex_up_id" id="flex_up_id<?php echo $key;?>" value="<?php echo $flex_up_id[$key];?>">
                                     ...
                                     <td><?php $this->widget('zii.widgets.jui.CJuiDatePicker',array('model'=>  PARTY_FLEX::model(),"name"=>"[$key]WET",'attribute'=>"[$key]WET",
                                                                  'options' => array('dateFormat'=>'dd/mm/yy','changeMonth' => 'true','changeYear' => 'true','constrainInput' => 'true',		
                                                                  'duration'=>'fast','showAnim' =>'slide'),'htmlOptions' => array('id'=>"WETT-$key",'value'=>$WET ,'class'=>'WET','style'=>"width:92px;height:25px",'rel'=>'WET')));?></td>
...
<!--            </div>-->
            ...
            <table>
                <tr class="spaceUnder">
                    ...
                    <td class="input-append" style="text-align:left;"><?php echo $form->textField($model,'PREFERRED_NAME',array('size'=>60,'maxlength'=>100,'style'=>'width:290px;','value'=>$PREFERRED_NAME)); ?> 
                        ...
                        <span class="add-on" style="width:3px !important"></span></a>
                    </td>
               </tr>
            </table>
  ...
  <table  class="partytype" id="party_type">
              ...
              <tr class="fixedHeader2" >
                  <td class="party_type"><?php echo$Getlabelname->Get_Labelname_Fnc("154"); ?><a class="field_level_help" href=""><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/diamond-icon.png" width="8" height="8" title="<?php echo $GetTitleHelp->Get_Title_Help();?>" ></a></td>
                  <td class="WEF" style="padding-right: 20px;"><?php echo$Getlabelname->Get_Labelname_Fnc("126"); ?><a class="field_level_help" href=""><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/diamond-icon.png" width="8" height="8" title="<?php echo $GetTitleHelp->Get_Title_Help();?> "></a></td>
                  <td class="WET" style="text-align: left"><?php echo$Getlabelname->Get_Labelname_Fnc("127");?><a class="field_level_help" href=""><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/diamond-icon.png" width="8" height="8" title="<?php echo $GetTitleHelp->Get_Title_Help();?>" ></a></td>
              </tr>
...
<!--        <td style="width:30px"><a><?php //echo CHtml::link( $Getlabelname->Get_Labelname_Fnc(""), '#', array('onclick'=>'$("#mydialog").dialog("open"); return false;',));?></a></td>   -->
        <td style="width:65px"><a id="Minfo" class="moreinfo"> <?php echo  $Getlabelname->Get_Labelname_Fnc("135");?></a>
                 ...
                 ?>
                     ...
                     <td style="width:78%; vertical-align: top;border:5px solid #e8e8e8;border-bottom:5px solid #e8e8e8 !important;">
                        <table id="second_table_contact" class="secondtablecontact">
                            ...
                            <tr class="spaceUnder">
                               <td class="margin1" style="font-size:13px !important"><b><?php echo$Getlabelname->Get_Labelname_Fnc("113"); ?></b></td><td class="margin1" style="padding-left: 5px;"><?php echo $form->textField(Entity_Contact::model(),"[$i]URL",array('id'=>"URL-$i",'value'=>$URL[$i],'class'=>'inputpermament'));?></td>
                                 <td class="margin1"></td>
...
<!--                                <td  class="" style="padding-top:0px !important;;padding-right: 10px;"><input type="text" name="add2"></td>-->
  ...
  <td style="vertical-align: top;padding-top: 7px;">
              <table id="bank-branch" style="margin-bottom:0px; background-color: #F8F8F8">
                  <tr>
                    <td width="auto">
                        <table id="bank_entity_bank" class="grid_insert_table_bankdetails" style="height: 150px;margin-top: 10px;margin-bottom: 10px;margin-left: 1px;">
...
<!--                            <tr>
                            ...
                            <tr class="spaceUnder">
                                <td class="banknameaccordion" style="padding-right: 37px;"><?php echo$Getlabelname->Get_Labelname_Fnc("194"); ?></td>
                                <td class="banknametextaccordion" style="padding-top: 0px;padding-right: 10px;">
                                 <?php echo $form->textField(Entity_Bank::model(),"ACCOUNT_NO",array("id"=>"ACCOUNT_NO",'value'=>$Account_No,'style'=>"width:268px;")); ?>
                                </td>
                            </tr>
                            
                            <tr class="spaceUnder">
                                <td  class="bankbranchaccordion" style="font-weight: bold;padding-right: 19px;" ><?php echo$Getlabelname->Get_Labelname_Fnc("195"); ?></td>
                            ...
                            <tr class="spaceUnder">
                                <td  class="" style="font-weight: bold;padding-right: 55px;padding-bottom: 0px;" ><?php echo$Getlabelname->Get_Labelname_Fnc("160"); ?></td>
                 ...
                 ?></td>
                            ...
                            <tr class="spaceUnder"><td style="padding-bottom:12px;"></td></tr>
                             <tr class="spaceUnder">
<!--                                <th> WEF</th>-->
                                 <td></td>
                                 <td style=""><?php echo$Getlabelname->Get_Labelname_Fnc("126"); ?> 
                                     <?php  $this->widget('zii.widgets.jui.CJuiDatePicker',array('model'=>Entity_Bank::model(),"attribute"=>"WEF",'value'=>'','options'=>array('showAnim'=>'slide','placeholder'=>'dd/mm/yy',
                                                                                                           'dateFormat'=>'dd/mm/yy',
                                                                                                           'changeMonth' => 'true',
                                                                                                           'changeYear'=>'true',
                                                                                                           'constrainInput' => 'false'),
...
<div id="data3"  class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable" style="display:none;position:absolute;padding:10px;background-color: white;width:auto;height:auto;z-index: 1002;top:200px;left:312px;border-radius: 5px;border-top-left-radius: 5px !important;border-top-right-radius: 5px !important;">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <img  src="<?php echo Yii::app()->request->baseUrl; ?>/images/cross.png" class="detailseditbtn2" onclick="closepopup3();" id="detailseditbtn-2" style="margin-left: 140px;margin-top: -29px;" title="Close">
         <br><br>
         
<!--  Table with Party_Flex from Basic Definition        -->

<table  class="grid_insert_table_Party_generic" id="Party_generic">
 <tbody class="ScrollContent" style="height:196px !important">
     <tr>
           <td style="vertical-align: top;padding-top: 0px;" id="get_party_generic_ajax">
            ...
            ?>    
                <?php    if($GetGenericFlex_party!="") { 
                    ...
                    ?>
                    <table  id="Party_generic" style="margin-top: 0px;margin-bottom: 0px;margin-left: -15px;">
               ...
               // ################### FOR NULL TEXT-FIELDS ########################### ############################## #####################                          
                ...
                // ################### FOR NULL TEXT-FIELDS ###########################  ###################################################                            
                        ...
                        ?>
                            ...
                            <tr class="spaceUnder">
                                <td class="" style="padding-right:20px;padding: 5px;width:140px;">
                                     <?php echo $value['FIELD_TITLE'];?>  </td>
                                <td style="padding: 5px;">
