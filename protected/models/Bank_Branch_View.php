...
/**
 * This is the model class for table "BANK_BRANCH_V".
 *
 * The followings are the available columns in table 'BANK_BRANCH_V':
 * @property integer $ID
 ...
 */
class Bank_Branch_View extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Bank_Branch_View the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('SHORT_NAME, NAME, BANK_ID', 'required'),
