...
<div class="form">
   ...
   // alert("Please fill above label id field !");
    ...
    <table border="2" class="grid_insert_table">
        <tr class="grid_title">
            <td>&nbsp;</td>
            <td height="23"><?php echo  $Getlabelname->Get_Labelname_Fnc("2000");?></td>
            <td><?php echo  $Getlabelname->Get_Labelname_Fnc("2001");?></td>
            <td><?php echo  $Getlabelname->Get_Labelname_Fnc("2002");?></td>
            <?php
        ...
        <tr class="tabular_submit_background">
            ...
            <td align="right" id="testtdright" class="tabular_submit_padding">
                ...
                <?php //echo CHtml::button($model->isNewRecord ? $Getlabelname->Get_Labelname_Fnc("2022") : $Getlabelname->Get_Labelname_Fnc("2021"),array('id'=>'demo_save')); ?>
                 <?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>"button",'size'=>'small', 'label'=>$model->isNewRecord ? $Getlabelname->Get_Labelname_Fnc("2022") : $Getlabelname->Get_Labelname_Fnc("2021"),'id'=>'demo_save','icon'=>'icon-thumbs-up')); ?>
                   <?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>"reset",'size'=>'small','icon'=>'icon-refresh', 'label'=>$Getlabelname->Get_Labelname_Fnc("2023"))); ?>
