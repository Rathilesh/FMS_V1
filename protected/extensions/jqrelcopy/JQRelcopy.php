...
class JQRelcopy extends CWidget
{
	 ...
	 *
	 */
	public $jsBeforeClone;
	// 'jsBeforeClone' => "alert(this.attr('class'));";
	...
	public function init()
	{
		...
		// old Yii::app()->getClientScript()->registerScript(__CLASS__.'#'.$this->id,"jQuery('#{$this->id}').relCopy($options);");
//        echo "alert($this->id)";
//        echo $options;
//        echo __CLASS__;
        Yii::app()->getClientScript()->registerScript
            (__CLASS__.'#'.$this->id,"jQuery('#{$this->id}').relCopy($options);");
