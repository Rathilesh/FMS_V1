...
///////////////code for show add button///////////////
 ...
 $("#Current_Click_Id").val($(this).attr("id"));
 });
            ...
            <td colspan="2">
                 ...
                 <table border="2" id="text_align_c">
                           ...
                           <tr class="row copy">
                              ...
                              <input class="menu_item_class" id="_<?php echo $i; ?>MenuItm" type="text" name="[<?php echo $i;?>]MenuItm" autocomplete="off">                          
                               <?php echo $form->hiddenField($model, "[$i]MMO_ID",array('class'=>'MMO_ID'));?></td>
                               <td>
                              <input class="menu_item_class" id="_<?php echo $i; ?>SubMenu" type="text" name="[<?php echo $i;?>]SubMenu" autocomplete="off">                                                   
...
<!--                                   <input type="text" name="[<?php //echo $i ?>]SUBMENU_MMD_ID_HIDDEN" class="SUBMENU_MMD_ID_HIDDEN" id="Md_Menu_Definition_<?php// echo $i; ?>_SUBMENU_MMD_ID_HIDDEN">-->
        ...
        <tr class="tabular_submit_background">
            <td colspan="5"   class="tabular_submit_padding">
              ...
              <input type="hidden" name="Current_Click_Id" id="Current_Click_Id" />
