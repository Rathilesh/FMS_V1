...
class Generic_Flex extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('TABLE_ID, FILED_SEQUENCE, FILED_TITLE, DATA_TYPE, MAX_LENGTH, IS_REQUIRED', 'required'),
			...
			array('ID, TABLE_ID, FILED_SEQUENCE, FILED_TITLE, DATA_TYPE, MAX_LENGTH, CANVAS, XCORDINATE, YCORDINATE, IS_REQUIRED', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'ID' => 'ID',
			'TABLE_ID' => 'Table',
			'FILED_SEQUENCE' => 'Filed Sequence',
			'FILED_TITLE' => 'Filed Title',
			'DATA_TYPE' => 'Data Type',
	...
	public function search()
	{
		...
		$criteria->compare('FILED_SEQUENCE',$this->FILED_SEQUENCE);
		$criteria->compare('FILED_TITLE',$this->FILED_TITLE,true);
