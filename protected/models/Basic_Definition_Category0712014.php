...
class Basic_Definition_Category extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('DESCRIPTION, IS_AMEND, IS_DISPLAY, IS_UNIVERSAL, IS_COMPULSORY, NO_OF_RECORDS', 'required'),
    ...
    public function relations()
    {
        ...
        return array(
            'bASICDEFINITIONs' => array(self::HAS_MANY, 'BASICDEFINITION', 'DFCTG_DEFINITION_TYPE'),
        );
    }
