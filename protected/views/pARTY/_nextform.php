            ...
            <tr>
                ...
                <td style="padding:6px">
                    ...
                    <table id="top_right_table" style="margin-bottom: 0px;">
                        <tr>
                            <td><?php echo $form->labelEx($model,'PERSONAL_ID',array('class'=>'required')); ?></td>
                                ...
                                <table style="margin-bottom:0px" id="toggle_include_table">
                                    <tr>
                                        ...
                                        <td style="border-bottom: none"><?php echo $form->toggleButtonRow($model, 'ACTIVE', array('options'=>array('enabledLabel'=>'Yes' , 'disabledLabel'=>'No'),'htmlOptions'=>array('type'=>'mini')),array('labelOptions' => array("label" => false))); ?></td>
                                            <td><?php echo $form->labelEx($model,'CASUAL',array('class'=>'required')); ?></td>
                                          <td><?php echo $form->dropDownList($model,'CASUAL', array('empty'=>'--Select--','Casual'=>'Casual','Normal'=>'Normal'),array('class'=>'form-control-select')); ?></td>
<!--                                        <td style="border-bottom: none"><label for="Personnel_V_VERIFIED1" class="required" style="display: block; ">Is Data Verified?</label></td>-->
<!--                                        <td style="border-bottom: none"><?php //echo $form->toggleButtonRow($model,'VERIFIED_BY_SELF' ,array('options'=>array('enabledLabel'=>'Self' , 'disabledLabel'=>'Employer')),array('labelOptions' => array("label" => false))); ?></td>-->
...
<!--                         <td> <label for="Personnel_V_ACTIVE1" class="required" style="display: block; ">Is Personnel Active? <span class="required">*</span></label></td>
                        ...
                        <tr>
                            <td><?php echo $form->labelEx($model,'SALUTATION',array('class'=>'required')); ?></td>
                            <td><div class="col-xs-2"><?php echo $form->textField($model,'SALUTATION',array('size'=>10,'class'=>'form-control')); ?></div></td>
                             <td><?php echo $form->labelEx($model,'FIRST_NAME',array('class'=>'required')); ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $form->dropDownList($model,'GENDER', CHtml::listData(BASIC_DEFINITION::model()->findAll("DFCTG_DEFINITION_TYPE='GENDER'"), 'SHORT_NAME', 'DESCRIPTION'), array('empty'=>'--Select--','class'=>'form-control-select'));
                                ?></td>
                            <td><?php echo $form->labelEx($model,'BLOOD_GROUP'); ?></td>
                            <td><?php echo $form->dropDownList($model,'BLOOD_GROUP', CHtml::listData(BASIC_DEFINITION::model()->findAll("DFCTG_DEFINITION_TYPE='BLOOD_GROUP'"), 'SHORT_NAME', 'DESCRIPTION'), array('empty'=>'--Select--','class'=>'form-control-select')); ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $form->labelEx($model,'NATIONALITY'); ?></td>
                            <td><?php echo $form->dropDownList($model,'NATIONALITY', CHtml::listData(BASIC_DEFINITION::model()->findAll(), 'NATIONALITY_CODE', 'NATIONALITY_NAME'), array('empty'=>'--Select--','class'=>'form-control-select')); ?></td>
                            <td><?php echo $form->labelEx($model,'RELIGION'); ?></td>
                            <td><?php echo $form->dropDownList($model,'RELIGION', CHtml::listData(BASIC_DEFINITION::model()->findAll("DFCTG_DEFINITION_TYPE='RELIGION'"), 'SHORT_NAME', 'DESCRIPTION'), array('empty'=>'--Select--','class'=>'form-control-select')); ?></td>
                            <td><?php echo $form->labelEx($model,'SUBCAST'); ?></td>
                            <td><?php echo $form->dropDownList($model,'SUBCAST', CHtml::listData(BASIC_DEFINITION::model()->findAll("DFCTG_DEFINITION_TYPE='SUBCAST'"), 'SHORT_NAME', 'DESCRIPTION'), array('empty'=>'--Select--','class'=>'form-control-select')); ?></td>
                        </tr>
                         <tr>
                            <td style="border-bottom: none"><label for="Personnel_V_VERIFIED1" class="required" style="display: block; ">Data Verified By</label></td>
                            <td><?php echo $form->dropDownList($model,'VERIFIED_BY_SELF', array('empty'=>'--Select--','Self'=>'Self','Employer'=>'Employer'),array('class'=>'form-control-select'),array('labelOptions' => array("label" => false))); ?></td>
                            <td><?php echo $form->labelEx($model,'VERIFIED_ON',array('class'=>'required')); ?></td>
                            
                            <td><?php echo $form->textField($model,'VERIFIED_ON',array('id'=>'verification_datepicker','placeholder'=>'dd/mm/yy')); ?>                              
                                 <span style="float:right"><?php echo $form->labelEx($model,'SECONDMENT'); ?></span></td>
                            <td><?php echo $form->dropDownList($model,'CASUAL', array('empty'=>'--Select--','Inward'=>'Inward','Outward'=>'Outward'),array('class'=>'form-control-select','id'=>'Secondmentid','onchange'=>'Secondmentorg();')); ?></td>
                            <td><?php echo $form->dropDownList($model,'CASUAL', array('empty'=>'--Select Organiztion--','ABC'=>'ABC','LOK'=>'LOK'),array('class'=>'form-control-select','id'=>'Secondmentorgid')); ?></td>
                        </tr>
                    </table>
