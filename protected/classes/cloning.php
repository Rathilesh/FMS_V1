         ...
         var cloneid = cloneval.split("+");
            ...
            cloned.find("input").each(function() {
                ...
                {   
                 ...
                 if($(this).attr('rel')=="NomineeAutocomplete")
                {   
                 id="nominee_name"+RowIndex;
                 name="["+RowIndex+"]"+"nominee_name"; 
                  $(this).autocomplete({                                            
                                       source: "<?php echo $this->createUrl('Personnel_V/DependentAutocomplete?val=Nominee')?>",
                                       minLength: 0,                                       
                                       change:function(event,ui){
                                        if (!ui.item) {
                                            $(this).val("");                                                                       
                 ...
                 if($(this).attr('rel')=="NextofkinAutocomplete")
                {   
                 id="nextofkin_name"+RowIndex;
                 name="["+RowIndex+"]"+"nextofkin_name"; 
                  $(this).autocomplete({                                            
                                       source: "<?php echo $this->createUrl('Personnel_V/DependentAutocomplete?val=Next Of Kin')?>",
                                       minLength: 0,                                       
                                       change:function(event,ui){
                                        if (!ui.item) {
                                            $(this).val("");                                                                       
